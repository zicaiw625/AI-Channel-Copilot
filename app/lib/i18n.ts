...
const dict: Record<string, TranslationEntry> = {
  ...
  dashboard_tools_label: { zh: "快捷入口", en: "Shortcuts" },
  dashboard_tools_title: { zh: "常用功能", en: "Quick access" },
  dashboard_tools_badge: { zh: "入口", en: "Shortcuts" },
  dashboard_shortcut_billing: { zh: "计费管理", en: "Billing" },
  dashboard_shortcut_advanced: { zh: "高级工具", en: "Advanced tools" },
  advanced_tools_page_heading: { zh: "高级工具", en: "Advanced tools" },
  advanced_tools_intro: { zh: "诊断、导出、团队协作等工具集中在此。", en: "Diagnostics, exports, collaboration, and more." },
  dashboard_reference_badge: { zh: "参考", en: "Reference" },
  dashboard_low_sample_badge: { zh: "低样本", en: "Low sample" },
  dashboard_data_source_prefix: { zh: "数据来源：", en: "Data source: " },
  ...
  dashboard_open_attribution: { zh: "打开追踪与归因", en: "Open Tracking & Attribution" },
  dashboard_llms_manage_cta: { zh: "在 AI SEO 中管理 llms.txt", en: "Manage llms.txt in AI SEO" },
  tracking_llms_pointer_title: { zh: "llms.txt 在 AI SEO 中管理", en: "Manage llms.txt in AI SEO" },
  tracking_llms_pointer_body: { zh: "llms.txt 属于内容可见性与 AI 发现设置，请在 AI SEO 工作区配置、同步与校验。", en: "llms.txt is part of content visibility and AI discovery. Configure, sync, and verify it in the AI SEO workspace." },
  tracking_llms_pointer_cta: { zh: "前往 AI SEO", en: "Go to AI SEO" },
  ...
  dashboard_open_ai_workspace: { zh: "打开 AI SEO 工作台", en: "Open AI SEO Workspace" },
  dashboard_review_attribution_rules: { zh: "检查归因规则", en: "Review Attribution Rules" },
  ...
  dashboard_tool_utm_wizard: { zh: "UTM 向导", en: "UTM Wizard" },
  dashboard_tool_copilot_growth: { zh: "Copilot（Pro/Growth）", en: "Copilot (Pro/Growth)" },
  ...
  dashboard_free_plan_notice: { zh: "当前为免费版（仅限查看最近 7 天数据）。", en: "You are on the Free plan (Limited to 7 days history)." },
