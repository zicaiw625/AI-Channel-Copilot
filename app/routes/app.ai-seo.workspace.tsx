    ...
    <s-page heading={en ? "AI SEO" : "AI SEO"}>
      <div className={styles.page}>
        ...
        <div className={styles.card}>
          ...
          >
            <Link to={buildDashboardHref(location.search)} className={styles.secondaryButton}>
              {en ? "Back to Dashboard" : "返回仪表盘"}
            </Link>
            <Link
              to={buildOptimizationHref(location.search)}
              className={styles.secondaryButton}
              style={{ background: "#008060", color: "#fff", borderColor: "#008060" }}
            >
