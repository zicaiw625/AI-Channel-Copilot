...
import { buildAttributionHref, getPreservedSearchParams, parseUtmTab } from "../lib/navigation";
import { AttributionDomainNav } from "../components/attribution/AttributionDomainNav";
...
export default function UTMWizard() {
  ...
  const backHref = buildAttributionHref(location.search);
  const backLabel = en ? "Back to Tracking & Attribution" : "返回追踪与归因";
    ...
    <s-page heading={en ? "AI Detection Setup Wizard" : "AI 检测设置向导"}>
      <div className={styles.page}>
        ...
        <div style={{ marginBottom: 16, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <AttributionDomainNav active="utm" en={en} />
        </div>
