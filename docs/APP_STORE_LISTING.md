...
## Suggested keywords
AI attribution, Shopify analytics, AI orders, AI GMV, UTM tracking, referrer tracking, AI SEO, llms.txt, schema, FAQ, ChatGPT traffic, Perplexity traffic, Gemini traffic, Copilot traffic

## Suggested pricing language
- Starter, for proving signal
